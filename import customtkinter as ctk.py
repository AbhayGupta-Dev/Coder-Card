...
# ------------------ BACKGROUND IMAGE ------------------
bg_img = Image.open(r"D:\Programing\Python\Coder Card\vivid-blurred-colorful-wallpaper-background.jpg").resize((900, 900))
...
# ------------------ IMAGE LOAD ------------------
base_image = Image.open(r"D:\Programing\Python\Coder Card\image.jpg").resize((360, 300))
